...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (servletPath.endsWith("/login") || servletPath.endsWith("/register") || servletPath.endsWith("/refresh-token")) {
        ...
        userNIK = jwtService.extractUsername(jwt);
        if (userNIK != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = this.userDetailsService.loadUserByUsername(userNIK);
