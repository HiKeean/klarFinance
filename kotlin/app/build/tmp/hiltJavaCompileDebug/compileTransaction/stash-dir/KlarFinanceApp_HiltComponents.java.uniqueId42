...
import com.klarfinance.app.core.location.LocationCaptureWorker_HiltModule;
import com.klarfinance.app.core.notification.KlarFirebaseMessagingService_GeneratedInjector;
import com.klarfinance.app.di.DatabaseModule;
...
public final class KlarFinanceApp_HiltComponents {
  private KlarFinanceApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          LocationCaptureWorker_HiltModule.class,
          NetworkModule.class,
          RepositoryModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements KlarFinanceApp_GeneratedInjector,
  ...
  @Subcomponent
  @ServiceScoped
  public abstract static class ServiceC implements KlarFirebaseMessagingService_GeneratedInjector,
      ServiceComponent,
      GeneratedComponent {
  ...
  @Subcomponent(
      modules = {
          ...
          PasswordLoginViewModel_HiltModules.KeyModule.class,
          QrisViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          PasswordLoginViewModel_HiltModules.BindsModule.class,
          QrisViewModel_HiltModules.BindsModule.class,
